...
class manual_entry(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        ttk.Label(self, text="Marital Status").grid(row=4, column=0, sticky="w")
        ...
        ttk.Label(self, text="Annual Salary").grid(row=12, column=0, sticky="w")
        ...
        ttk.Label(self, text="Loan Request Amount").grid(row=17, column=0, sticky="w")
